...
export default function Account() {
  return (
    <div className="min-h-screen bg-[#f8fafb] md:pb-0 pb-20">
      <div className="md:hidden">
        <TopBar title="Your Account" showSearch={false} />
      </div>

      {/* Desktop Header */}
      <div className="hidden md:block max-w-2xl mx-auto pt-8 px-5">
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Your Account</h1>
      </div>

      <div className="max-w-2xl mx-auto md:mt-6">
        {/* Clean Profile Section */}
        <div className="relative px-5 pb-8 -mt-2 md:mt-0 md:rounded-t-3xl overflow-hidden" style={{
