...
import { Menu, X, ShoppingBag, User, LogOut, MapPin, HelpCircle, ChevronDown, Home, Settings } from 'lucide-react';
    ...
    <Link to="/" className="flex items-center gap-2 group shrink-0">
      ...
      <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#1D6076] to-[#2a7a94] flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow">
        <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
          <path
            d="M12 3C7.5 3 4 6.8 4 11.5C4 14.5 5.5 17.1 7.8 18.7L7 21l3-1.2c.6.2 1.3.2 2 .2 4.5 0 8-3.8 8-8.5C20 6.8 16.5 3 12 3z"
            fill="white"
            opacity="0.9"
          />
          <path
            d="M8.5 10.5c0-1.1.9-2 2-2s2 .9 2 2v3h-1.5v-2.5c0-.3-.2-.5-.5-.5s-.5.2-.5.5V13.5H8.5V10.5z"
            fill="#EBA050"
          />
...
export function TopNav() {
  ...
  const navLinks = [
    ...
    { to: '/nearby',  label: 'Laundries', icon: MapPin },
            ...
            {isLoggedIn && user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm text-gray-900 font-medium hidden sm:block">{user.firstName}</span>
                ...
                {userMenu && (
                  <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50">
                    ...
                    {[
                      ...
                      { to: '/orders',   label: 'My Orders',   Icon: ShoppingBag },
                      { to: '/billing',  label: 'Billing',     Icon: () => <span className="text-sm">💳</span> },
