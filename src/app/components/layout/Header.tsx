    ...
    <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-xl border-b border-slate-100/80 flex items-center justify-between px-4 lg:px-6 shrink-0" dir="ltr">
      <div className="flex items-center gap-3">
        ...
        <div className="relative hidden md:flex items-center">
          ...
          <input
            ...
            className="w-72 lg:w-80 bg-slate-50/80 border border-slate-200/60 text-slate-700 text-[13px] rounded-xl pl-9 pr-16 py-2 focus:ring-2 focus:ring-[#1D6076]/10 focus:border-[#1D6076]/30 transition-all placeholder:text-slate-400"
          />
      ...
      <div className="flex items-center gap-2">
              ...
              <>
                ...
                >
                  <div className="p-3.5 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-semibold text-[#1D6076] bg-[#1D6076]/10 px-2 py-0.5 rounded-full">3 new</span>
                  </div>
                  ...
                  <div className="p-2.5 border-t border-slate-100 text-center">
                    <button className="text-[12px] font-semibold text-[#1D6076] hover:underline">View All</button>
                  </div>
                </motion.div>
              </>
            )}
        ...
        <button className="flex items-center gap-2 p-1.5 hover:bg-slate-50 rounded-xl transition-colors">
          <img
            src="https://ui-avatars.com/api/?name=Ahmed+M&background=1D6076&color=fff&size=64"
            alt="Admin"
