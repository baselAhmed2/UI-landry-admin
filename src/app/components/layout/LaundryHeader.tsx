...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  "/": { title: "Dashboard", subtitle: "Welcome back, Ahmad" },
  "/orders": { title: "Orders", subtitle: "Manage and track all laundry orders" },
  "/services": { title: "Services", subtitle: "Manage your laundry service offerings" },
  "/availability": { title: "Availability", subtitle: "Set your working hours and schedule" },
  "/notifications": { title: "Notifications", subtitle: "Stay updated with latest alerts" },
  "/payments": { title: "Payments", subtitle: "Track revenue and payment history" },
...
export function LaundryHeader({ notificationCount = 3 }: LaundryHeaderProps) {
  ...
  const pageInfo = pageTitles[pathKey ?? "/"] ?? { title: "Ndeef Admin", subtitle: "" };
